...
function gm_info_writer(number){
    document.getElementsByClassName(gfh)[1].innerHTML=gm_name.name[number]
    document.getElementById("special").innerHTML=gm_special.special[number]
    document.getElementById("gm_1").innerHTML=gm_1.info[number]
    document.getElementById("gm_2").innerHTML=gm_2.info[number]
    document.getElementById("gm_3").innerHTML=gm_3.info[number]
    document.getElementById("gm_4").innerHTML=gm_4.info[number]
